...
const activityJavaDir = path.join(projectRoot, 'android', 'app', 'src', countryCode, 'java', 'com', 'multicountrydemo');
fs.mkdirSync(activityJavaDir, {recursive: true});
fs.writeFileSync(path.join(activityJavaDir, `${activityClassName}.kt`), `package com.multicountrydemo
